...
function IntroImage({ langFont, introImgs, introImgConfig}) {
  ...
  for (let i = 0; i < introImgs.length; i++) {
    ...
    let imgObjectPositionStyle = 'center center'
    if (introImgs[i].mobileImgObjectPosition && imgStyle === introBaseStyle.centerMobileImg){
      imgObjectPositionStyle = introImgs[i].mobileImgObjectPosition
    }
