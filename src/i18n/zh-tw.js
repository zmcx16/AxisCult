const zh_TW = {
  ...
  'marquee.text1': `就是現在! 快加入阿克西斯教吧!!! 現在加入就送可以吃的肥皂再加上兩倍的點數更附上可以喝的洗衣精!!! 如果加入的同時還拉三個人一起入教的話還贈送艾莉斯教美女祭司的胖次!!! 阿克西斯教阿克西斯教阿克西斯教阿克西斯教阿克西斯教阿克西斯教阿克西斯教阿克西斯教!!!`,
  ...
  'introCreed.text5': `阿克西斯教教義第七項：汝，勿要忍耐。想喝的時候就喝，想吃的時候就吃便好。因為明天並不見得還能吃得到。`,
  'introCreed.text6': `反正都要失敗不如放手去做，失敗之後跑路就好了。`,
  'introCreed.text7': `請放心，神會赦免一切。汝，要愛巨乳，汝，要愛貧乳；阿克西斯教的教義是容許一切。即使是同性戀者，即使是喜好非人獸耳少女者，即使是蘿莉控，即使是尼特；只要對象並非不死者或惡魔少女，只要有愛且不犯法，全都可以得到赦免。`,
  'introCreed.text8': `汝，虔誠的教徒啊。為了不再受到惡魔所誘惑，記住這句咒語吧。「艾莉絲的胸部是墊出來的」。今後若是你的心又受到誘惑，就記得詠唱這句咒語。若是遇見其他受到誘惑的人，告訴他們這句咒語也是好事一樁。`,
  'introCreed.text9': `艾莉絲的胸部是墊出來的!!! 艾莉絲的胸部是墊出來的!!! 艾莉絲的胸部是墊出來的!!!`,
